<%-- 
    Document   : inativar_emp
    Created on : 18 de nov. de 2023, 16:59:36
    Author     : Henrique
--%>
...
<html>
    ...
    <body>
        ...
        boolean updateRealizado = empresaDAO.inativar(empresa);
        %>
        <div class="row g-3 p-3 mx-auto" style="max-width: 95%; margin: 50px auto">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (updateRealizado) { %>
                            <p class="card-text">Empresa inativada com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Empresa não inativada!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
