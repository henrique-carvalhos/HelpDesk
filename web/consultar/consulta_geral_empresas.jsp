...
<body>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="consulta_geral_empresas.jsp">Empresas</a>
                  <li><a class="dropdown-item" href="consulta_geral_depart.jsp">Departamentos</a>
                  <li><a class="dropdown-item" href="consulta_geral_locais.jsp">Locais</a>
                </ul>
              </li>
            </ul>
          </div>
    ...
    <div class="row g-3 p-3 mx-auto" style="max-width: 95%; margin: 50px auto">
        <p class="h3">Lista de Empresas</p>
        <div class="row">
            <%
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card mb-3">
                    <div class="card-header">
                        Código: <%= empresa.getId_empresa() %>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Nome Fantasia: <%= empresa.getNome_fantasia() %></h5>
                        <p class="card-text">Razão Social: <%= empresa.getRazao_social() %></p>
                        <p class="card-text">CNPJ: <%= empresa.getCnpj() %></p>
                        <p class="card-text">E-mail: <%= empresa.getEmail() %></p>
                        <p class="card-text">Contato: <%= empresa.getNome_contato() %></p>
                        <p class="card-text">Telefone: <%= empresa.getTelefone() %></p>
                        <div class="text-end">
                            <a href="../alterar/editar_empresa.jsp?id_empresa=<%= empresa.getId_empresa() %>" class="btn btn-primary">Editar</a>
                            <a href="../inativar/inativar_emp.jsp?id_empresa=<%= empresa.getId_empresa() %>" class="btn btn-danger">Inativar</a>
                        </div>
                    </div>
                </div>
            </div>
