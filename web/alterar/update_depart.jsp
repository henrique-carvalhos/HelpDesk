<%-- 
    Document   : update_depar
    Created on : 8 de nov. de 2023, 19:33:56
    Author     : Henrique
--%>
...
<head>
    ...
    <body>
        ...
        <%
        String id_depart = request.getParameter("id_depart");
        String nomeDepart = request.getParameter("nomeDepartamento");    
        
        Departamento departamento = new Departamento();
        departamento.setId_depart(id_depart);
        departamento.setNome_depart(nomeDepart);
        
        
        DepartamentoDAO departamentoDAO = new DepartamentoDAO();
        boolean updateRealizado = departamentoDAO.update(departamento);
        %>
        <div class="row g-3 p-3 mx-auto" style="max-width: 95%; margin: 50px auto">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (updateRealizado) { %>
                            <p class="card-text">Departamento atualizado com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Departamento não atualizado!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
                                <a href="../consultar/consulta_geral_depart.jsp" class="btn btn-primary">Voltar</a>
