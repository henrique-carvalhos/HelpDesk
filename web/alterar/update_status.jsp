<%-- 
    ...
    Created on : 17 de nov. de 2023, 21:07:10
    Author     : Henrique
--%>
...
<html>
    ...
    <body>
        ...
        boolean updateRealizado = chamadoDAO.update(chamado);
        %>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <% if (updateRealizado) { %>
                            <p class="card-text">Chamado atualizado com sucesso!</p>
                                <% } else { %>
                            <p class="card-text">Chamado não atualizado!</p>
                                <% } %>
                            </h5>
                                <div class="text-end">
                                    <a href="../consultar/lista-chamados.jsp" class="btn btn-primary">Voltar</a>
