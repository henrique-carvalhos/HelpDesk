...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Criar Solicitantes</title>
    ...
    <body>
        ...
        <form class="row g-3 border p-3 mx-auto" style="max-width: 90%; margin: 50px auto" method="post" action="cadastrar/cadastrar_solicitante.jsp">
            <p class="h3">Criar Solicitantes</p>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="sobrenomeSolicitante">
            </div>
            <div class="col-12">
