...
<html>
    ...
    <nav class="navbar navbar-expand-lg " style="background-color: #aaaba9;">
        ...
        boolean cadastroRealizado = empresaDAO.cadastrar(empresa);
        %>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (cadastroRealizado) { %>
                            <p class="card-text">Empresa cadastrada com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Empresa não cadastrada!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
                                <a href="../cadastrar-empresas.html" class="btn btn-primary">Novo</a>
