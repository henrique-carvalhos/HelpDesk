...
<html>
    ...
    <nav class="navbar navbar-expand-lg " style="background-color: #aaaba9;">
        ...
        String assunto3 = request.getParameter("assunto3");
        String tipoSolicitacao = request.getParameter("tipoSolicitacao");
        String status = request.getParameter("status");
        String descricao = request.getParameter("descricao");
        
        String assunto = assunto1 + "-" + assunto2 + "-" + assunto3 + "-" + tipoSolicitacao;
        ...
        boolean cadastroRealizado = chamadoDAO.cadastrar(chamado);
        %>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (cadastroRealizado) { %>
                            <p class="card-text">Chamado cadastrado com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Chamado não cadastrado!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
                                <a href="../criar-chamado.jsp" class="btn btn-primary">Novo</a>
