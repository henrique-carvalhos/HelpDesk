<%-- 
    Document   : inativar_depart
    Created on : 18 de nov. de 2023, 16:59:16
    Author     : Henrique
--%>
...
<head>
        ...
        <title>Inativar departamento</title>
    </head>
    <body>
        ...
        boolean updateRealizado = departamentoDAO.inativar(departamento);
        %>
        <div class="row g-3 p-3 mx-auto" style="max-width: 95%; margin: 50px auto">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (updateRealizado) { %>
                            <p class="card-text">Departamento inativado com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Departamento não inativado!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
