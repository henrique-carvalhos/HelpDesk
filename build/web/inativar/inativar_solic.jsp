...
<html>
    <head>
        ...
        <title>Inativar solicitante</title>
    </head>
    <body>
        ...
        boolean updateRealizado = solicitanteDAO.inativar(solicitante);
        %>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <% if (updateRealizado) { %>
                            <p class="card-text">Solicitante inativado com sucesso!</p>
                                <% } else { %>
                            <p class="card-text">Solicitante não inativado!</p>
                                <% } %>
                            </h5>
                                <div class="text-end">
