...
<html>
    ...
    <nav class="navbar navbar-expand-lg " style="background-color: #aaaba9;">
        ...
        boolean cadastroRealizado = localDAO.cadastrar(local);
        %>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (cadastroRealizado) { %>
                            <p class="card-text">Local cadastrado com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Local não cadastrado!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
                                <a href="../cadastrar-locais.html" class="btn btn-primary">Novo</a>
