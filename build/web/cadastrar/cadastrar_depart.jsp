...
<html>
    ...
    <nav class="navbar navbar-expand-lg " style="background-color: #aaaba9;">
        ...
        <%
        String nome_depart = request.getParameter("nomeDepartamento");
        
        Departamento departamento = new Departamento();
        departamento.setNome_depart(nome_depart);
        
        DepartamentoDAO departamentoDAO = new DepartamentoDAO();
        boolean cadastroRealizado = departamentoDAO.cadastrar(departamento);
        %>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (cadastroRealizado) { %>
                            <p class="card-text">Departamento cadastrado com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Departamento não cadastrado!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
                                <a href="../cadastrar-departamentos.html" class="btn btn-primary">Novo</a>
