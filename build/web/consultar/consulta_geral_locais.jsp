            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card mb-3">
                    <div class="card-header">
                        Código: <%= local.getId_local() %>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Nome: <%= local.getNome_local() %></h5>
                        <div class="text-end">
                            <a href="../alterar/editar_local.jsp?id_local=<%= local.getId_local() %>" class="btn btn-primary">Editar</a>
                            <a href="../inativar/inativar_local.jsp?id_local=<%= local.getId_local() %>" class="btn btn-danger">Inativar</a>
                        </div>
                    </div>
                </div>
            </div>
