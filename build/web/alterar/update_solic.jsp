<%-- 
    Document   : update_solic.jsp
    Created on : 1 de nov. de 2023, 15:43:25
    Author     : Henrique
--%>
...
<html>
    <head>
        ...
        <title>Atualizar solicitante</title>
    </head>
    <body>
        ...
        <%
        String id_solic = request.getParameter("id_solic");
        String nomeSolicitante = request.getParameter("nomeSolicitante");
        String sobrenomeSolicitante = request.getParameter("sobrenomeSolicitante");
        ...
        solicitante.setId_solic(id_solic);
        solicitante.setNome_solic(nomeSolicitante);
        solicitante.setSobrenome_solic(sobrenomeSolicitante);
        solicitante.setEmail_solic(email);
        solicitante.setEmpresa(nomeEmpresa);
        solicitante.setDepartamento(nomeDepartamento);
        solicitante.setLocal(nomeLocal);
        
        
        SolicitanteDAO solicitanteDAO = new SolicitanteDAO();
        boolean updateRealizado = solicitanteDAO.update(solicitante);
        %>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <% if (updateRealizado) { %>
                            <p class="card-text">Solicitante atualizado com sucesso!</p>
                                <% } else { %>
                            <p class="card-text">Solicitante não atualizado!</p>
                                <% } %>
                            </h5>
                                <div class="text-end">
                                    <a href="../consultar/consulta_geral_solicitantes.jsp" class="btn btn-primary">Voltar</a>
