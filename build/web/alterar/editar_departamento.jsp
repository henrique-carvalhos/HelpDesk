<%-- 
    ...
    Created on : 8 de nov. de 2023, 19:33:41
    Author     : Henrique
--%>
...
<html>
    ...
    <body>
        ...
        <%
        String depart = request.getParameter("id_depart");
        
        Departamento departamento = new Departamento();
        departamento.setId_depart(depart);
        
        DepartamentoDAO departamentoDAO = new DepartamentoDAO();
        
        if (departamentoDAO.consultarId(departamento) != null){
        %>
        <form class="row g-3 border p-3 mx-auto" style="max-width: 90%; margin: 50px auto" method="post" action="update_depart.jsp?id_depart=<%= departamento.getId_depart() %>">
            <p class="h3">Editar Departamento - <%= departamento.getId_depart() %></p>
            <div class="col-12">
              <label  class="form-label">Nome</label>
              <input type="text" class="form-control" name="nomeDepartamento" value="<%= departamento.getNome_depart() %>">
            </div>
            <div class="col-12">
        ...
        <%          
            ...
            out.println("<br> <b>Departamento não encontrado! <b>");
        }       
