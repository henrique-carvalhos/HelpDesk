<%-- 
    ...
    Created on : 11 de nov. de 2023, 17:55:48
    Author     : Henrique
--%>
...
<html>
    ...
    <body>
        ...
        <%
        String emp = request.getParameter("id_empresa");
        
        Empresa empresa = new Empresa();
        empresa.setId_empresa(emp);

        EmpresaDAO empresaDAO = new EmpresaDAO();
        
        if (empresaDAO.consultarId(empresa) != null){
        %>
        <form class="row g-3 border p-3 mx-auto" style="max-width: 90%; margin: 50px auto" method="post" action="update_empresa.jsp?id_empresa=<%= empresa.getId_empresa() %>">
            <p class="h3">Editar empresa - <%= empresa.getId_empresa() %></p>
            <div class="col-12">
              <label for="inputEmail4" class="form-label">Nome Fantasia</label>
              <input type="text" class="form-control" name="nomeFantasia" value="<%= empresa.getNome_fantasia() %>">
            </div>
            <div class="col-12">
              <label for="inputPassword4" class="form-label">Razão Social</label>
              <input type="text" class="form-control" name="razaoSocial" value="<%= empresa.getRazao_social() %>">
            </div>
            <div class="col-md-6">
              <label for="inputPassword4" class="form-label">CNPJ</label>
              <input type="text" class="form-control" name="cnpj" value="<%= empresa.getCnpj() %>">
            </div>
            <div class="col-md-6">
              <label for="inputPassword4" class="form-label">Contato</label>
              <input type="text" class="form-control" name="nomeContato" value="<%= empresa.getNome_contato() %>">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="telefone" value="<%= empresa.getTelefone() %>">
            </div>
            <div class="col-12">
        ...
        <%          
            ...
            out.println("<br> <b>Empresa não encontrado! <b>");
        }       
