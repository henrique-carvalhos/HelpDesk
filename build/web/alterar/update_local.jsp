<%-- 
    Document   : update_local
    Created on : 9 de nov. de 2023, 20:04:13
    Author     : Henrique
--%>
...
<html>
    ...
    <body>
        ...
        String nome_local = request.getParameter("nomeLocal");    
        
        Local local = new Local();
        local.setId_local(id_local);
        local.setNome_local(nome_local);
        
        
        LocalDAO localDAO = new LocalDAO();
        boolean updateRealizado = localDAO.update(local);
        %>
        <div class="row g-3 p-3 mx-auto" style="max-width: 95%; margin: 50px auto">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <h5 class="card-title">
                        <% if (updateRealizado) { %>
                            <p class="card-text">Local atualizado com sucesso!</p>
                        <% } else { %>
                            <p class="card-text">Local não atualizado!</p>
                        <% } %>
                    </h5>
                            <div class="text-end">
                                <a href="../consultar/consulta_geral_locais.jsp" class="btn btn-primary">Voltar</a>
