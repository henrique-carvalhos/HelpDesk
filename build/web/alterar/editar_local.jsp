<%-- 
    Document   : editar_local
    Created on : 9 de nov. de 2023, 20:03:57
    Author     : Henrique
--%>
...
<html>
    ...
    <body>
        ...
        <%
        String loc = request.getParameter("id_local");
        
        Local local = new Local();
        local.setId_local(loc);
        
        LocalDAO localDAO = new LocalDAO();
        
        if (localDAO.consultarId(local) != null){
        %>
        <form class="row g-3 border p-3 mx-auto" style="max-width: 90%; margin: 50px auto" method="post" action="update_local.jsp?id_local=<%= local.getId_local() %>">
            <p class="h3">Editar local - <%= local.getId_local() %></p>
            <div class="col-12">
              <label  class="form-label">Nome</label>
              <input type="text" class="form-control" name="nomeLocal" value="<%= local.getNome_local() %>">
            </div>
            <div class="col-12">
        ...
        <%          
            ...
            out.println("<br> <b>Local não encontrado! <b>");
        }       
